        ...
        NavigationStack {
            ScrollView {
                ...
                VStack {
                    ...
                    DatePicker("Due Date", selection: $targetDate)
            ...
            .toolbar {
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let newHabit: HabitItem = HabitItem(name: habitName, purpose: purpose, type: habitType, targetDate: targetDate, dateAdded: creationDate, dateLastUpdated: creationDate)
